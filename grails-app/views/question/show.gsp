	...
	<body>
		...
		<div id="show-question" class="content scaffold-show" role="main">
			...
			<ol class="property-list question">
				...
				<g:if test="${questionInstance?.alternatives}">
				<li class="fieldcontain">
					<span id="alternatives-label" class="property-label"><g:message code="question.alternatives.label" default="Alternatives" /></span>
					
						<g:each in="${questionInstance.alternatives}" var="a">
						<span class="property-value" aria-labelledby="alternatives-label"><g:link controller="alternative" action="show" id="${a.id}">${a?.encodeAsHTML()}</g:link></span>
						</g:each>
				...
				<g:if test="${questionInstance?.evaluations}">
				<li class="fieldcontain">
					<span id="evaluations-label" class="property-label"><g:message code="question.evaluations.label" default="Evaluations" /></span>
					
						<g:each in="${questionInstance.evaluations}" var="e">
