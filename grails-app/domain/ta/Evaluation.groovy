...
class Evaluation {
    ...
    public boolean compatibleToNoValue(Evaluation evaluationInstance){
        if(this.origin.equals(evaluationInstance.getOrigin()) && this.applicationDate.compareTo(evaluationInstance.getApplicationDate())==0 && this.criterion.equals(evaluationInstance.getCriterion()))
        {
            return true
        }else {
            return false
