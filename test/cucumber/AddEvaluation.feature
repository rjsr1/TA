...
Feature: AddEvaluation
  ...
  Scenario: Import evaluations
    Given I organized all evaluations for the "X" criterion originated from "Test", dated from "31/03/2016" in a spreedsheet
    When I want to import all evaluations from the spreedsheet to add to all students "X" criterias history, originated from "Test" and dated from "31/03/2016"
  ...
  Scenario: Import repeated evaluations
    ...
    And there already are evaluations for the "X" criterion, originated from "Midterm" and dated from "31/03/2016" in the system
